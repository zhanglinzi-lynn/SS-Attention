...
from models import CNN,RNN,LSTNet,SMHA_Net
import importlib
...
parser.add_argument('--data', type=str, default='traffic.txt', help='location of the data file')
parser.add_argument('--model', type=str, default='SMHA_Net', help='')
...
parser.add_argument('--hidRNN', type=int, default=50, help='number of RNN hidden units (channels)')
